...
(* OASIS_START *)
(* DO NOT EDIT (digest: b82a6944eb11baf789c4f0a0045aec3d) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "xapi_login_bot.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "#X9\163\207\000&(t\216\219\t{\198\204Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
